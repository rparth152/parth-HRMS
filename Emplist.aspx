                ...
                <asp:DataList ID="DataList1" runat="server" RepeatColumns="4" RepeatDirection="Horizontal">
                    <ItemTemplate>
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top" src='<%#Eval("p rofile") %>'' alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title"><b>Name:</b><%#Eval("name") %></h5>
								<ul class="list-group list-group-flush">
									<li class="list-group-item"<b>Salary:</b><%#Eval("role") %></li>
									<li class="list-group-item"<b>Reporting to:</b><%#Eval("manager") %></li>
