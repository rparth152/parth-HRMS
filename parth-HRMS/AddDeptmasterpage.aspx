<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddDeptmasterpage.aspx.cs" Inherits="parth_HRMS.AddDeptmasterpage" %>
                       ...
                       <asp:GridView ID="GridView1" runat="server"
                           ...
                           <Columns>
                               <asp:TemplateField HeaderText="DepartmentId">
                                   <ItemTemplate>
                                       <asp:Label ID="Did" runat="server" Text='<%#Eval("DepartmentId") %>'></asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>
                               <asp:BoundField DataField="Name" HeaderText="Dapartment" />
                               <asp:TemplateField HeaderText="DepartmentId">
                                   <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Action">
                                   <ItemTemplate>
                                       <asp:LinkButton ID="btnEdit" runat="server" CommandName="EditRow" CommandArgument='<%#Eval("DepartmentId") %>'>
            <i class="ti ti-edit"></i>
                                       </asp:LinkButton>
                                       <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" CommandArgument='<%#Eval("DepartmentId") %>'>
