                    ...
                    <div class="grid-card">
                        <asp:GridView ID="GridView1" runat="server"
                            ...
                            <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <itemtemplate>
                                                <asp:LinkButton ID="btnEdit" runat="server" CommandName="EditRow" CommandArgument='<%#Eval("RoleId") %>'>
                                                    <i class="ti ti-edit"></i>
                                                </asp:LinkButton>
                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" CommandArgument='<%#Eval("RoleId") %>'>
